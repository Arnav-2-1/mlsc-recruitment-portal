  ...
  return (
    <Card className="border-slate-800 bg-slate-900/40 flex flex-col justify-between">
      <form onSubmit={handleStart} className="space-y-4 flex-grow">
        <h3 className="text-lg font-bold text-slate-200 mb-2 border-b border-slate-800 pb-2">Candidate Verification</h3>
        ...
        {error && <p className="text-xs font-semibold text-rose-400 bg-rose-500/5 border border-rose-500/10 p-2.5 rounded-lg">{error}</p>}
      </form>
